...
cd ~
wget https://github.com/PIVX-Project/PIVX/releases/download/v5.4.0/pivx-5.4.0-x86_64-linux-gnu.tar.gz 
tar -xvzf pivx-5.4.0-x86_64-linux-gnu.tar.gz
mkdir ./pivx
mv pivx-5.4.0/bin/pivx-cli ./pivx
mv pivx-5.4.0/bin/pivxd ./pivx
chmod +x ./pivx*
